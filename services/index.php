            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-service brand-hover radius-4 mb-30 text-center">
                        ...
                        <div class="service-text">
                            <h3>Web-дизайн</h3>
                            <p>Создание индивидуальной концепции, от лаконичных решений до сложных динамических элементов.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-service brand-hover radius-4 mb-30 text-center">
                        ...
                        <div class="service-text">
                            <h3>Продвижение</h3>
                            <p>От SEO-оптимизации до контекстной рекламы. Всё для того, чтобы сайт собирал тысячи лидов.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-service brand-hover radius-4 mb-30 text-center">
                        <div class="service-icon">
                            <span class="icon-toolbox" aria-hidden="true"></span>
                        </div>
                        <div class="service-text">
                            <h3>Поддержка</h3>
                            <p>Поправим, переделаем и реализуем новые решения на уже готовом сайте, а также предложим
                                идеи по улучшению.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-service radius-4 brand-hover mb-30 text-center">
                        <div class="service-icon">
                            <span class="icon-pictures" aria-hidden="true"></span>
                        </div>
                        <div class="service-text">
                            <h3>Контент</h3>
                            <p>Подготовим лучший контент от написания статей до подбора музыкального сопровождения и
                                напоним сайт.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="single-pricing text-center mb-30">
                        ...
                        <div class="get-started">
                            <a href="/services_landing.php" class="btn">Узнать больше</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="single-pricing text-center mb-30">
                        ...
                        <div class="get-started">
                            <a href="/services_online_shop.php" class="btn premium-bg">Узнать больше</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
